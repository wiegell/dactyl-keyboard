...
(def thumb-connectors
  (union
   ...
   (triangle-hulls
    ...
    (key-place 3 cornerrow web-post-bl))
   (triangle-hulls
    (key-place (inc 3) lastrow web-post-tl)
    (key-place 3 lastrow web-post-tr)
    (key-place (inc 3) lastrow web-post-bl)
    (key-place 3 lastrow web-post-br))
   (triangle-hulls
    (key-place (inc 4) lastrow web-post-tl)
    (key-place 4 lastrow web-post-tr)
    (key-place (inc 4) lastrow web-post-bl)
...
(def case-walls
  (union
   ...
   ; right wall
   (for [y (range 0 (+ lastrow 1))] (key-wall-brace lastcol y 1 0 web-post-tr lastcol y       1 0 web-post-br))
   (for [y (range 1 (+ lastrow 1))] (key-wall-brace lastcol (dec y) 1 0 web-post-br lastcol y 1 0 web-post-tr))
   ...
   (key-wall-brace 3 lastrow 0.5 -1 web-post-br 4 lastrow 1 -1 web-post-bl)
